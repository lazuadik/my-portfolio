        ...
        <div className="container-data-journey">
            <div className ="container-data-journey-background">
                <div className="container-data-journey-text">
                    ...
                    <p>I’ve always loved math and design. In my first two years of university, I was active in UI/UX—joining competitions, working on freelance projects, and tutoring.</p>
                    <p>In my third year, I shifted to data science, starting with small projects, campus work, and Bangkit Academy (Machine Learning track).</p>
